...
test_that("Additional authors are returned in specified order", {
  expect_equal(get_authors("./get-authors/add-ordered-authors-to-citation.tex", include_editors = FALSE), 
               c("Stephen Duckett", "Lemony Snicket", "Hal Swerissen"))
})
