...
It may have mandatory or optional arguments, which occur immediately after \verb=\begin{environment}=.  
 ...
 \caption{Examples of environments}
  ...
  \item They will perform the following steps:
    \begin{enumerate}
      \item Visit \url{https://travis-ci.org/grattan/grattex.svg?branch=master} and verify: \includegraphics[height=1em]{figure/passing.png}.
      ...
      \item Copy \verb=https://github.com/grattan/grattex= to your clipboard
      \item Visit \url{https://github.com/new/import}
      \item Paste \verb=https://github.com/grattan/grattex= into the \textbf{Your old repository's clone URL} field.
